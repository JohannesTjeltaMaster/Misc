...
if __name__=='__main__':
    ...
    plt.legend()
    plt.grid()
    plt.xlabel('Prescribed dose [Gy]',fontsize=13)
    plt.ylabel('mean difference [Gy]',fontsize=13)
    ...
    plt.plot(mu1_2,complex(mu1_2,t),label='Model 1.2Mev')
    plt.plot(mu1_4,complex(mu1_4,t14),label='Model 1.4Mev')
    plt.plot(mu1_8,complex(mu1_8,t18),label='Model 1.8Mev')
    plt.plot(mu8,complex(mu8,t8),label='Model 8.7Mev')
    plt.grid()
    plt.legend()
    ...
    plt.plot(np.linspace(0.5,100,1000),complex(1,np.linspace(0.5,100,1000)),'--',label='1Gy S')
    plt.plot(np.linspace(0.5,100,1000),complex(3,np.linspace(0.5,100,1000)),'--',label='3Gy S')
